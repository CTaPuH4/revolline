...
const Footer = () => {
    ...
    const copyEmail = () => {
        navigator.clipboard.writeText("misha@revolline.ru");
        setCopiedEmail(true);
        ...
        <footer className="footer">
            <div className="footer-content">
                <div>
                    ...
                    <Link to="/info/privacy" className="foot-text">
                        Политика конфиденциальности
                    </Link>
                    <br />
                    <Link to="/info/deal" className="foot-text">
                ...
                <div>
                    ...
                    <div className="click-wrapper" onClick={copyEmail}>
                        <p className="foot-text-click">misha@revolline.ru</p>
