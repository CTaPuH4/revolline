...
*Доступно только авторизованным пользователям.*
#### Пример запроса:
**POST** ***"http://127.0.0.1:8000/api/users/me/change_password/"***
```
{
...
### Изменение количества товаров в коризне
*Доступно только авторизированным пользователям.*
#### Пример запроса:
**PATCH** ***"http://127.0.0.1:8000/api/cart/2/"***
```
{
    "quantity": 22
}
...
*Доступно только авторизированным пользователям.*
#### Пример запроса:
**DELETE** ***"http://127.0.0.1:8000/api/favorites/2/"***
#### Пример ответаа: 204 No Content
